...
TEST_F(BiDiTest, app_adr_alternate_primary_id1_id2) {
...
TEST_F(BiDiTest, app_adr_alternate_logon_id1_id2) {
  _addrs.logon = {.value = 1337u, .type = dcc::Address::Long};
  _addrs.received = _addrs.logon;
